...
const MoviesShows = () => {
  ...
  return (
    <main>
      <section className='flex flex-col px-3.75 lg:px-40'>
        <section className=' relative mt-20'>
          ...
          >
            {mainMovies.map((card) => (
              <CategoryCard
                cardBgClass={""}
                imgBgClass={"relative h-full pt-6 lg:pt-10 pb-4 px-6 lg:px-10"}
                imageClass={"object-cover h-120 lg:h-full rounded-xl border box-border border-[#262626]"}
                imageSrc={card.imgSrc}
                shadowClass={"absolute pt-6 lg:pt-10 pb-4 px-6 lg:px-10 top-0 left-0 w-full h-full bg-linear-[180deg,#14141400_50%,#14141466_60%,#141414_90%]"}
              ...
              >
                <div className='flex flex-col lg:flex-row gap-1 lg:gap-5'>
                  <Button customClass='flex rounded-lg py-3.5 lg:px-5 items-center justify-center w-full gap-1 bg-[#E50000] cursor-pointer'>
                    <FaPlay className='size-6 text-white' />
                    <Typography customClass='font-semibold text-sm'>Play Now</Typography>
                  </Button>
                  <div className='flex gap-2'>
                    <button className='flex rounded-lg border box-border border-[#262626] bg-[#0F0F0F] p-3 gap-2.5 cursor-pointer'>
